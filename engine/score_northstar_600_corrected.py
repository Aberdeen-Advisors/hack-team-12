...
OUT_XLSX = os.path.join(DATA, "Northstar-Disposition-Analysis-600-corrected.xlsx")
OUT_CSV = os.path.join(DATA, "northstar-dispositions-600-corrected.csv")
OUT_MD = os.path.join(DATA, "northstar-600-corrected-summary.md")
...
OUT_TOOL_XLSX = os.path.join(DATA, "Northstar-600-corrected-tool-vocabulary.xlsx")
OUT_TOOL_CSV = os.path.join(DATA, "northstar-600-corrected-tool-vocabulary.csv")
