...
| `score_northstar_600_corrected.py` | The same dataset run against Bina's corrected re-upload of the 600-application workbook, plus the tool-vocabulary export. Imports the v3 model unchanged. **Not the submission run — that is `score_northstar_600_tuned.py` below.** |
